      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            ...
            >
              <TableCell sx={{ color: "#2065d1" }}>Name</TableCell>
            ...
            {salesman
              ...
              .map((salesman) => (
                ...
                >
                  ...
                  <TableCell align="center">{salesman.phone}</TableCell>
                  <TableCell align="center">{salesman.nid}</TableCell>
                  <TableCell align="center">{salesman.address}</TableCell>
